 ...
 * @author aqm
 */
public class Rx7028rPanel4 extends javax.swing.JPanel {

    /**
     * Creates new form Router1Panel2
     */
    public Rx7028rPanel4() {
        initComponents();
    }
    ...
    */
    ...
    private void initComponents() {
        ...
        jlTexto.setText("Conectar tarjeta inalámbrica ");
        ...
        jLabel5.setText("5.- Introducir en la ranura identificada como  WLAN la tarjeta con la etiqueta ");
        jPanel1.add(jLabel5);

        jLabel6.setText("      de la cara principal hacia arriba y empuje físicamente hasta conseguir su plena conexión.");
        jPanel1.add(jLabel6);

        jLabel7.setText("      La parte metálica de la tarjeta sobresaldrá unos 1.5 cm aproximadamente.");
        jPanel1.add(jLabel7);
        jPanel1.add(jLabel8);
        jPanel1.add(jLabel2);
        jPanel1.add(jLabel4);
