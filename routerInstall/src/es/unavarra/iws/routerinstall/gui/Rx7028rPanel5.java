 ...
 * @author aqm
 */
public class Rx7028rPanel5 extends javax.swing.JPanel {

    /**
     * Creates new form Router1Panel2
     */
    public Rx7028rPanel5() {
        initComponents();
    }
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel3.setText("6.- Conectar el cable ADSL de la clavija extensora al puerto ADSL del router.");
        jPanel1.add(jLabel3);

        jLabel5.setText("7.- Conecta el cable de alimentación al router y a la toma eléctrica.");
        jPanel1.add(jLabel5);

        jLabel6.setText("8.- Una vez conectado el router a la toma de corriente, presionar el botón de encendido, ");
        jPanel1.add(jLabel6);

        jLabel7.setText("      verificando que el led de encendido se active. ");
        jPanel1.add(jLabel7);

        jLabel8.setText("Si el led no enciende ir al paso 7");
        jPanel1.add(jLabel8);
        jPanel1.add(jLabel2);
        jPanel1.add(jLabel4);
