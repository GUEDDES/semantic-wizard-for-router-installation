package es.unavarra.iws.routerinstall.gui.wiz;
...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
   ...
   /**
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("es.unavarra.iws.routerinstall.gui.Principal");
            url = c.getResource("/es/unavarra/iws/routerinstall/resources/img/"+name);
    ...
    static {
        ...
        try { 
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                ResourceBundle.getBundle("es.unavarra.iws.routerinstall.gui.wiz");
            ...
            FINISH_TEXT = "Finalizar";
            
            BACK_ICON = new ImageIcon((URL)getImage("previous_.png"));
            NEXT_ICON = new ImageIcon((URL)getImage("next_.png"));
            CANCEL_ICON = new ImageIcon((URL)getImage("cancel_.png"));
            FINISH_ICON = new ImageIcon((URL)getImage("finish_.png"));
