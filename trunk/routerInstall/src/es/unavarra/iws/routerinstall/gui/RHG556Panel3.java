 ...
 * @author aqm
 */
public class RHG556Panel3 extends javax.swing.JPanel {
    ...
    */
    ...
    private void initComponents() {
        ...
        jlTexto.setText("Conectar el Router");
        ...
        jLabel5.setText("2.- Conectar el cable ADSL de la clavija extensora al puerto ADSL del router.");
        jPanel1.add(jLabel5);

        jLabel6.setText("3.- Conectar el cable de alimentación al router y a la toma eléctrica.");
        jPanel1.add(jLabel6);

        jLabel7.setText("4.- Una vez conectado el router a la toma de corriente, presionar el botón de encendido,");
        ...
        jLabel2.setText("Si el led no se enciende ir al paso 3.");
        jPanel1.add(jLabel2);
        jPanel1.add(jLabel4);
