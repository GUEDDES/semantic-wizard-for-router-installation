 ...
 * @author aqm
 */
public class RTG585v7Panel8 extends javax.swing.JPanel {

    /**
     * Creates new form Router1Panel2
     */
    public RTG585v7Panel8() {
        initComponents();
    }
    /*
    ...
    try {
        if (java.awt.Desktop.isDesktopSupported()) {
            ...
            if (desktop.isSupported(java.awt.Desktop.Action.BROWSE)) {
                desktop.browse(new java.net.URI("http://movil.orange.es/contenidos/pdf/internet/Manual_thomson_TG585v7.pdf"));
            }
        }
    } catch (Exception e) {
        e.printStackTrace();
...
// TODO add your handling code here:
    ...
    try {
        if (java.awt.Desktop.isDesktopSupported()) {
            java.awt.Desktop desktop = java.awt.Desktop.getDesktop();
            if (desktop.isSupported(java.awt.Desktop.Action.BROWSE)) {
                desktop.browse(new java.net.URI("http://movil.orange.es/contenidos/pdf/internet/guia_rapida_thomsom_TG585v7.pdf"));
            }
        }
    } catch (Exception e) {
        e.printStackTrace();
