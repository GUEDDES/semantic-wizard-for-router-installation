 ...
 * @author aqm
 */
public class Rct351Panel4 extends javax.swing.JPanel {
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("6.- Conectar el cable de alimentación al router y a la toma eléctrica.");
        jPanel1.add(jLabel2);

        jLabel5.setText("7.- Una vez conectado el router a la toma de corriente, presionar el botón de encendido,");
        jPanel1.add(jLabel5);

        jLabel6.setText("      verificando que el led de encendido se active");
        jPanel1.add(jLabel6);

        jLabel7.setText("Si el led no se enciende, ir al paso 6.");
        jPanel1.add(jLabel7);
        jPanel1.add(jLabel8);
        jPanel1.add(jLabel4);
